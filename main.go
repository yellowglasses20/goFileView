...
func run() int {
	...
	drawServiceList(serviceList, textView, app)
...
func selectDirOrFile(fs os.FileInfo, nextFilePath string, serviceList *tview.List, bucketList *tview.TextView, app *tview.Application) {
	...
	createTextView(bucketList, nextFilePath, app)
}

func createTextView(bucketList *tview.TextView, f string, app *tview.Application) {
	bucketList.Clear()
